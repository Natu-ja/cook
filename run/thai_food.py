...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", default="pythainlp/thai_food_v1.0", type=str, choices=["pythainlp/thai_food_v1.0"], help="https://huggingface.co/datasets/pythainlp/thai_food_v1.0")
