...
from .src.data_preprocessing import load_raw_dataset, formatting_func_Recipes_Greek as formatting_func
...
def run_training(args: Namespace, train_dataset: Dataset):
    ...
    if args.data_collator=="LanguageModeling":
        ...
        data_collator = DataCollatorForCompletionOnlyLM(
            response_template=tokenizer.encode("# Βοηθός\n", add_special_tokens=False),
            instruction_template=tokenizer.encode("# Μεταχειριζόμενος\n", add_special_tokens=False),
            mlm=False,
            tokenizer=tokenizer
        )
...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", default="Depie/Recipes_Greek", type=str, choices=["Depie/Recipes_Greek"], help="https://huggingface.co/datasets/Depie/Recipes_Greek")
    parser.add_argument("--tokenizer", default="lighteternal/gpt2-finetuned-greek", type=str, help="Tokenizer name or path.")
    parser.add_argument("--model", default="lighteternal/gpt2-finetuned-greek", type=str, help="Model name or path.")
