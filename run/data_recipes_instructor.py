...
from src.data_preprocessing import load_raw_dataset, formatting_func_data_recipes_instructor as formatting_func
...
if __name__ == "__main__":
    ...
    # SFT Config
    parser.add_argument("--output-dir", default="tmp_trainer/data_recipes_instructor", type=str)
