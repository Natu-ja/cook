...
if __name__ == "__main__":
    ...
    parser.add_argument("--dataset", default="./raw_data/cookpad_data.tsv", type=str, help="Path to the dataset file.", choices=["./raw_data/cookpad_data.tsv", "AWeirdDev/zh-tw-recipes-sm", "Erik/data_recipes_instructor", "mertbozkurt/llama2-TR-recipe", "pythainlp/thai_food_v1.0", "SuryaKrishna02/aya-telugu-food-recipes"])
