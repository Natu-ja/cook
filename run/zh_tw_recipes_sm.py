...
from .src.data_preprocessing import load_raw_dataset, formatting_func_zh_tw_recipes_sm as formatting_func
...
def run_training(args: Namespace, train_dataset: Dataset):
    ...
    if args.data_collator=="LanguageModeling":
        ...
        data_collator = DataCollatorForCompletionOnlyLM(
            response_template=tokenizer.encode("# 助手\n", add_special_tokens=False),
            instruction_template=tokenizer.encode("# 用户\n", add_special_tokens=False),
            mlm=False,
            tokenizer=tokenizer
        )
...
if __name__ == "__main__":
    ...
    # SFT Config
    parser.add_argument("--output-dir", default="tmp_trainer/zh_tw_recipes_sm", type=str)
